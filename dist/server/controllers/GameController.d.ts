...
export declare class GameController {
    ...
    handleTradeRequest(player: PlayerRuntime, msg: any): void;
    handleTradeRespond(player: PlayerRuntime, msg: any): void;
    handleTradeSetItem(player: PlayerRuntime, msg: any): void;
    handleTradeRemoveItem(player: PlayerRuntime, msg: any): void;
    handleTradeSetCurrency(player: PlayerRuntime, msg: any): void;
    handleTradeLock(player: PlayerRuntime): void;
    handleTradeConfirm(player: PlayerRuntime): void;
    handleTradeCancel(player: PlayerRuntime): void;
    handleStorageOpen(player: PlayerRuntime, msg: any): void;
    handleStorageClose(player: PlayerRuntime): void;
    handleStorageDeposit(player: PlayerRuntime, msg: any): void;
    handleStorageWithdraw(player: PlayerRuntime, msg: any): void;
    handlePetSummon(player: PlayerRuntime, msg: any): Promise<void>;
    handlePetUnsummon(player: PlayerRuntime): Promise<void>;
    handlePetFeed(player: PlayerRuntime, msg: any): Promise<void>;
    handlePetRename(player: PlayerRuntime, msg: any): Promise<void>;
    handlePetSetBehavior(player: PlayerRuntime, msg: any): Promise<void>;
    handlePetState(player: PlayerRuntime): Promise<void>;
    handleGuildCreate(player: PlayerRuntime, msg: any): Promise<void>;
    handleGuildInvite(player: PlayerRuntime, msg: any): Promise<void>;
    handleGuildRespondInvite(player: PlayerRuntime, msg: any): Promise<void>;
    handleGuildLeave(player: PlayerRuntime): Promise<void>;
    handleGuildKick(player: PlayerRuntime, msg: any): Promise<void>;
    handleGuildSetRank(player: PlayerRuntime, msg: any): Promise<void>;
    handleGuildState(player: PlayerRuntime): Promise<void>;
    ...
    buildWorldSnapshot(mapId?: string, mapKey?: string): {
        ...
        groundItems: ({
            ...
            bonusPercents: Record<string, string | number | boolean>;
            x: number;
            y: number;
            mapId: string;
            ownerId: number | null;
    ...
    private resolveTargetMobForPet;
    ...
    private pruneExpiredGuildInvites;
    private clearGuildInvitesForPlayer;
    private findOnlinePlayerByName;
    private resolveAdminTarget;
    private sendFriendState;
    private hydrateFriendStateForPlayer;
    private hydrateGuildStateForPlayer;
    private sendGuildState;
