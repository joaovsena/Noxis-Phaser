    ...
    handleMessage(ws, raw) {
        ...
        switch (msg.type) {
            ...
            case 'friend.list':
                ...
                break;
            case 'trade.request':
                this.controller.handleTradeRequest(player, msg);
                break;
            case 'trade.respond':
                this.controller.handleTradeRespond(player, msg);
                break;
            case 'trade.setItem':
                this.controller.handleTradeSetItem(player, msg);
                break;
            case 'trade.removeItem':
                this.controller.handleTradeRemoveItem(player, msg);
                break;
            case 'trade.setCurrency':
                this.controller.handleTradeSetCurrency(player, msg);
                break;
            case 'trade.lock':
            ...
            case 'trade.cancel':
                ...
                break;
            case 'storage.open':
                this.controller.handleStorageOpen(player, msg);
                break;
            case 'storage.close':
                this.controller.handleStorageClose(player);
                break;
            case 'storage.deposit':
                this.controller.handleStorageDeposit(player, msg);
                break;
            case 'storage.withdraw':
                this.controller.handleStorageWithdraw(player, msg);
                break;
            case 'pet.summon':
                void this.controller.handlePetSummon(player, msg);
                break;
            case 'pet.unsummon':
                void this.controller.handlePetUnsummon(player);
                break;
            case 'pet.feed':
                void this.controller.handlePetFeed(player, msg);
                break;
            case 'pet.rename':
                void this.controller.handlePetRename(player, msg);
                break;
            case 'pet.setBehavior':
                void this.controller.handlePetSetBehavior(player, msg);
                break;
            case 'pet.state':
                void this.controller.handlePetState(player);
                break;
            case 'guild.create':
                this.controller.handleGuildCreate(player, msg);
                break;
            case 'guild.invite':
                this.controller.handleGuildInvite(player, msg);
                break;
            case 'guild.respondInvite':
                this.controller.handleGuildRespondInvite(player, msg);
                break;
            case 'guild.leave':
                this.controller.handleGuildLeave(player);
                break;
            case 'guild.kick':
                this.controller.handleGuildKick(player, msg);
                break;
            case 'guild.setRank':
                this.controller.handleGuildSetRank(player, msg);
                break;
            case 'guild.state':
